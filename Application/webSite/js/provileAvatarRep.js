...
function confirmPic(){
    ...
    if(checkDoc[0] == true){
        ...
        var population = "<img id='profilePic' src='../css/images/Avatars/rep_a_male.png' alt='Profile Picture' width='200px' height='200px'>";
        pictureFrame1.innerHTML = population;
    }
    if(checkDoc[1] == true){
        var population = "<img id='profilePic' src='../css/images/Avatars/rep_b_male.png' alt='Profile Picture' width='200px' height='200px'>";
        pictureFrame1.innerHTML = population;
    }
    if(checkDoc[2] == true){
        var population = "<img id='profilePic' src='../css/images/Avatars/rep_i_male.png' alt='Profile Picture' width='200px' height='200px'>";
        pictureFrame1.innerHTML = population;
    }
    if(checkDoc[3] == true){
        var population = "<img id='profilePic' src='../css/images/Avatars/rep_w_male.png' alt='Profile Picture' width='200px' height='200px'>";
        pictureFrame1.innerHTML = population;
    }
    if(checkDoc[4] == true){
        var population = "<img id='profilePic' src='../css/images/Avatars/rep_a_female.png' alt='Profile Picture' width='200px' height='200px'>";
        pictureFrame1.innerHTML = population;
    }
    if(checkDoc[5] == true){
        var population = "<img id='profilePic' src='../css/images/Avatars/rep_b_female.png' alt='Profile Picture' width='200px' height='200px'>";
        pictureFrame1.innerHTML = population;
    }
    if(checkDoc[6] == true){
        var population = "<img id='profilePic' src='../css/images/Avatars/rep_i_female.png' alt='Profile Picture' width='200px' height='200px'>";
        pictureFrame1.innerHTML = population;
    }
    if(checkDoc[7] == true){
        var population = "<img id='profilePic' src='../css/images/Avatars/rep_w_female.png' alt='Profile Picture' width='200px' height='200px'>";
        pictureFrame1.innerHTML = population;
    }
}
