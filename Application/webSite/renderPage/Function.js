...
function newSTL()
{
    if(!stlopen)
    {
        document.getElementById("videoRec").innerHTML = "<hr><h1>STL Upload</h1><br><br><input type='file' id='STLUpload'/><input class='btn btn-dark' type='submit' value='Upload Model' onclick='uploadSTL(document.getElementById(" + '"STLUpload"' + ").files[0])'><br><br>";
    }
    else{
        document.getElementById("videoRec").innerHTML = "";
    }
